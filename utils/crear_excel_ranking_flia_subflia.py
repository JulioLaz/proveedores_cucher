...
#                       congelados y anchos automáticos. Snippet de descarga
#                       de un solo click incluido.
# ═══════════════════════════════════════════════════════════════════════════════
# '''
...
#         # === ORDEN DE COLUMNAS PARA EL REPORTE (defensivo) ===
#         orden_deseado = [
#             'Ranking', 'Proveedor', 'Familia', 'Subfamilia',
#             # 'Ranking', 'Proveedor', 'ID Proveedor', 'Familia', 'Subfamilia',
#             '% Participación Ventas', 'Venta Total', 'Costo Total', 'Utilidad',
#             'Rentabilidad %', '% Participación Utilidad', 'Presupuesto',
#             '% Participación Presupuesto', 'Cantidad Vendida', 'Artículos',
...
#         # === GRUPOS DE FORMATO POR NOMBRE DE COLUMNA ===
#         cols_dinero = {'Venta Total', 'Costo Total', 'Utilidad',
#                        'Presupuesto', 'Costo Exceso'}
#         cols_pct = {'Rentabilidad %', '% Participación Ventas',
#                     '% Participación Utilidad', '% Participación Presupuesto'}
#         cols_entero = {'Ranking','Cantidad Vendida',
#         # cols_entero = {'Ranking', 'ID Proveedor', 'Cantidad Vendida',
#                        'Artículos', 'Art. con Exceso', 'Art. Sin Stock'}
...
#             # --- AutoFiltro ---
#             ws.auto_filter.ref = f'A{fila_header}:{ultima_col}{fila_data_fin}'

#             # --- Panes congelados (header + columnas clave fijas) ---
#             col_freeze = 6 if n_cols >= 6 else 1  # fija hasta 'Subfamilia'
...
# ═══════════════════════════════════════════════════════════════════════════════
#  USO EN STREAMLIT — DESCARGA DE UN SOLO CLICK
# ═══════════════════════════════════════════════════════════════════════════════
#  Clave: NO usar st.button(...) y luego st.download_button(...) (eso = 2 clicks).
#  Se genera el Excel una vez (cacheado) y se pone st.download_button DIRECTO.
#
#  @st.cache_data(ttl=300, show_spinner=False)
#  def _excel_ranking_flias_bytes(df, fecha_desde, fecha_hasta):
#      buf = crear_excel_ranking(df, fecha_desde, fecha_hasta)
