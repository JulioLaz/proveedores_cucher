...
def analizar_quiebre(df_stock):
    ...
    for suc, porc_col in zip(sucursales, porc_cols):
        ...
        temp = temp.merge(stock_suc, on='idarticulo', how='left')
        temp['stock_actual'] = temp['stock_actual'].fillna(0)
